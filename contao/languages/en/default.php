...
$GLOBALS['TL_LANG']['MOD']['guc_search_config']     = ['Table configuration', 'Configurable content sources for the search index'];
...
$GLOBALS['TL_LANG']['tl_module']['guc_search_types'] = ['Content types to search', 'Which content types should appear in search results. Empty = all types.'];
