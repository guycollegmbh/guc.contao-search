...
$GLOBALS['TL_LANG']['MOD']['guc_search_index']      = ['Suchindex', 'Index-Status und manuelle Neuindexierung'];
...
$GLOBALS['TL_LANG']['FMD']['guc_search_results'] = ['Erweiterte Suche — Ergebnisseite', 'Rendert die Suchergebnisse serverseitig aus dem FTS-Index. Liest «keywords» und «type» aus der URL.'];
$GLOBALS['TL_LANG']['tl_module']['guc_search_resultsPage'] = ['Weiterleitungsseite', 'Seite mit der vollständigen Suchergebnisansicht.'];
$GLOBALS['TL_LANG']['tl_module']['guc_search_types'] = ['Suchkategorien', 'Welche Kategorien und Inhaltstypen in der Suche erscheinen sollen. Leer = alle aktiven Kategorien.'];
$GLOBALS['TL_LANG']['tl_module']['guc_search_types_options'] = [
    '_categories' => 'Manuelle Kategorien (alle aktiven)',
    'news'        => 'News',
    'event'       => 'Events',
    'member'      => 'Team',
    'faq'         => 'FAQ',
...
$GLOBALS['TL_LANG']['tl_module']['guc_search_perPage'] = ['Treffer pro Seite', 'Anzahl Ergebnisse pro Seite bzw. pro Kategorie in der Übersicht (Standard: 10).'];
$GLOBALS['TL_LANG']['tl_module']['guc_search_layout'] = ['Darstellung', 'Inline: Suchfeld und Treffer stehen direkt im Seiteninhalt. Overlay: eine Lupe öffnet die Suche über der ganzen Seite.'];
...
$GLOBALS['TL_LANG']['MSC']['guc_search_open'] = 'Suche öffnen';
$GLOBALS['TL_LANG']['MSC']['guc_search_close'] = 'Suche schliessen';
